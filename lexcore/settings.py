...
# jasmin settings 9/12

JAZZMIN_SETTINGS = {
    # title of the window (Will default to current_admin_site.site_title if absent or None)
    "site_title": "LEXCore Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Welcome to LEXCore",
    ...
    "login_logo": "lexcore/assets/images/LEXCORE.jpg",
    ...
    "welcome_sign": "Welcome to the LEXCore",

    # Copyright on the footer
    "copyright": "LEXLink Information Technology Services",
    ...
    "order_with_respect_to": ["auth", "client", "matter", 'activity.task_detail', 'invoice.Bills', 'invoice.FilingFees', 'invoice.OPE'],
    ...
    "icons": {
        ...
        "client.Client_Data": "fab fa-earlybirds",
    },
