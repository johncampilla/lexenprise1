...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('activity', '0027_alter_task_detail_billstatus_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='task_detail',
            name='mail_type',
            field=models.CharField(blank=True, choices=[('Email', 'Email'), ('IPO', 'IPO'), ('Mail', 'Mail'), ('Court', 'Court'), ('Personal', 'Personal')], max_length=15, null=True),
        ),
        migrations.AlterField(
            model_name='task_detail',
            name='tran_type',
