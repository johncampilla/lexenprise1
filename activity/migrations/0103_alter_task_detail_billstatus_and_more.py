...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('activity', '0102_alter_task_detail_doc_type_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='task_detail',
            name='mail_type',
            field=models.CharField(blank=True, choices=[('Mail', 'Mail'), ('Personal', 'Personal'), ('Court', 'Court'), ('IPO', 'IPO'), ('Email', 'Email')], max_length=15, null=True),
        ),
        migrations.AlterField(
            model_name='task_detail',
            name='tran_type',
