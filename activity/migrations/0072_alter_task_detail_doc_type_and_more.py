...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('activity', '0071_alter_task_detail_billstatus_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='task_detail',
            name='mail_type',
            field=models.CharField(blank=True, choices=[('Email', 'Email'), ('Personal', 'Personal'), ('Court', 'Court'), ('Mail', 'Mail'), ('IPO', 'IPO')], max_length=15, null=True),
        ),
        migrations.AlterField(
            model_name='task_detail',
            name='tran_type',
