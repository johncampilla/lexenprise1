...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('activity', '0074_alter_task_detail_billstatus_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='task_detail',
            name='mail_type',
            field=models.CharField(blank=True, choices=[('Mail', 'Mail'), ('Personal', 'Personal'), ('IPO', 'IPO'), ('Email', 'Email'), ('Court', 'Court')], max_length=15, null=True),
        ),
        migrations.AlterField(
            model_name='task_detail',
            name='tran_type',
